...
//This is where I have begun to create the legend, defining characters with their colors.
	...
	var legendContent = "The movements of the following characters appear on the interactive map in their respective colors. The filtering mechanisms on the left side of the map allows you to view one character's movement at a time (top filter) or filter by part of book (bottom filter). To start a new filter, click the 'x' button on the right side of the filter box.<br><br><b><u>Filter by Character</u></b><br>" + colorPrincess + "<br>" + colorPrince + "<br>" + colorNemours + "<br>" + colorCour + "<br>" + colorHenri + "<br>" + colorElisabeth + "<br>" + vidameColor + "<br>"
...
//character legend tab
	...
	//creation of map information panel
		...
		"<b>Europe 1644</b>: Blaeu, Willem, <i>Europa Recens Descripta</i>, Amsterdam, 1644, 41 cm x 55 cm. <a target='_blank' href='https://www.davidrumsey.com/luna/servlet/detail/RUMSEY~8~1~285941~90058459:Europa-recens-descripta-?sort=pub_list_no_initialsort%2Cpub_date%2Cpub_list_no%2Cseries_no&qvq=q:Europa%20Recens%20Descripta;sort:pub_list_no_initialsort%2Cpub_date%2Cpub_list_no%2Cseries_no;lc:RUMSEY~8~1&mi=1&trs=2'>Link</a><br><br>"+
		...
		"<b>Paris 1575</b>: Braun, Georg and Hogenberg, <i>Franz, Lutetia, vulgari nomine Paris</i>, [atlas map], Cologne, Peter von Brachel, 1575, 35 cm x 48 cm. <a target='_blank' href='https://www.davidrumsey.com/luna/servlet/detail/RUMSEY~8~1~286750~90059245:Vol-I--7--Lutetia,-vulgari-nomine-P'>Link</a><br><br>"+
		"<b>Paris 1615</b>: Merian, Mathieu, <i>Le Plan de la Ville, Cité, Université et Fauxbourgs de Paris</i>, Paris, Nicolas de Mathonier, 1615, six plates of 90 cm x 102 cm. Facsimile: Paris, A. Taride, 1908. <a target='_blank' href='https://www.davidrumsey.com/luna/servlet/detail/RUMSEY~8~1~301368~90072328:Pl--XV--Paris-en-1615-?sort=pub_list_no_initialsort%2Cpub_date%2Cpub_list_no%2Cseries_no&qvq=q:merian;sort:pub_list_no_initialsort%2Cpub_date%2Cpub_list_no%2Cseries_no;lc:RUMSEY~8~1&mi=10&trs=348'>Link</a><br><br>"+
		"<b>Paris 1652</b>: Gomboust, Jacques, <i>Lutetia, Paris</i>, Paris, Impr. Ch. Chardon, 1652, nine plates of 33 cm x 50 cm. Facsimile: Paris, Taride, 1900. <a target='_blank' href='https://www.davidrumsey.com/luna/servlet/detail/RUMSEY~8~1~301378~90072338:Composite-Map--Pl--XVIII--Paris-en-?sort=pub_list_no_initialsort%2Cpub_date%2Cpub_list_no%2Cseries_no&qvq=q:Gomboust%20Paris;sort:pub_list_no_initialsort%2Cpub_date%2Cpub_list_no%2Cseries_no;lc:RUMSEY~8~1&mi=4&trs=5'>Link</a><br><br>" +
		"<b>Paris 1675</b>: •	Rochefort, Jouvin de, <i>Paris et ses environs</i>, Paris, Sieur de Richesource, 1672-75, nine plates of 49 cm x 60 cm. Facsimile: Paris, Impr. Ch. Chardon aîné, 1870. <a target='_blank' href='https://gallica.bnf.fr/ark:/12148/btv1b53010929s/'>Link</a>";
		var mapInfoContent = {
...
/////////////////////////////////////////////////////////////////////////////////////////////
		...
		var lafayette = L.marker([48.84908775346996, 2.3335981943120765]);
			...
			function lafayetteContent()
			{
				...
				"<i>Lafayette a principalement habité dans la rue de Vaugirard, située à proximité du Palais du Luxembourg. Pendant son enfance, Marie-Madeleine Pioche de La Vergne (1634–1693) habite au no 48, puis au no 50, rue de Vaugirard. Elle devient demoiselle d’honneur d’Anne d’Autriche et commence à fréquenter les salons de Paris, dont ceux de la marquise de Rambouillet et de Madeleine de Scudéry. Juste après son mariage avec le comte de Lafayette en 1655, elle habite dans les domaines de son mari en Auvergne. À compter de 1660, elle réside principalement dans son hôtel particulier dans la rue de Vaugirard, avec un degré élevé d’indépendance. Les membres de la noblesse et les gens de lettres fréquentent son salon. La marquise de Sévigné, le duc de La Rochefoucauld et Henriette d’Angleterre, belle-sœur du roi Louis XIV, sont parmi les gens proches de son entourage qui fréquentent le salon de Lafayette.</i>";
				return popupContent;
			};
