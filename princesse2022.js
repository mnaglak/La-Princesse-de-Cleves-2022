...
//character legend tab
	...
	//Sets the initial left sidebar content for popup pane and sites of interest pane
		...
		var sitesContent = 'Click on one of the following sites to zoom to the desired location. By then clicking on the location marker, a popup window with images opens and a short description of the location appears in the left sidebar. Note that Cercamp and Résidence de Lafayette do not have images.' +
